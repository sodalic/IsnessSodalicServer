...
curl POST https://www.googleapis.com/compute/v1/projects/dauntless-graph-293915/zones/us-east1-b/instances
{
  "kind": "compute#instance",
  "name": "gpu-isness-server-sc-p100-1",
  ...
  "sourceMachineImage": "projects/dauntless-graph-293915/global/machineImages/gpu-isness-server-sc-p100-1",
